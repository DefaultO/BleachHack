...
public class SettingItemList extends SettingList<Item> {
	...
	@Override
	public void renderItem(Minecraft mc, GuiGraphicsExtractor drawContext, Item item, int x, int y, int w, int h) {
		if (item == null || item == Items.AIR) {
			...
			drawContext.item(new ItemStack(item), (int) ((x + 1) * offset), (int) ((y + 1) * offset));
